...
render(){
  ...
  <View accessibilityLabel="Hold food to modify" style={{width: 400, maxWidth: 300, alignItems: 'center', marginBottom: 7, marginTop: 7, borderColor: '#5EA9F4', borderWidth: 2}} onStartShouldSetResponder= {() =>
      ...
      <Text>Carbs: {this.props.carbs} (g), Fat: {this.props.fat} (g), Protein: {this.props.protein} (g)</Text>
  </View>
  );
}  
